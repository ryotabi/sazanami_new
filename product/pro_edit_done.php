    ...
    <main>
        ...
        <div class="form-wrap" >
            ...
            if($pro_gazou_name!==$pro_gazou_name_old){
                unlink('../img/product/'.$pro_gazou_name_old);
            }


            print '<p style="font-size:20px; color:#000;">'.$pro_name.'を'.$pro_price.'円で修正しました。</p>';
            print '<img src="../img/product/'.$pro_gazou_name.'" alt="商品画像" width="100px" height="100px">';
            }catch(Exception $e){
