...
<body>
    ...
    <main>
        ...
        <div class="form-wrap" >
            ...
            <p class="management-text">価格：<?php print $pro_price;?></p>
            <div><img src="../img/product/<?php print $pro_gazou_name;?>" alt="" width="100px" height="100px"></div>
            <p class="management-text">本当に削除してよろしいですか？</p>
            <form action="pro_delete_done.php" method="post" class="edit_form-wrap">
