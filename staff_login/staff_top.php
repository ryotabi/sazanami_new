...
<body>
    ...
    <main>
        ...
        <div class="form-wrap">
            <p class="management-text"><a class="management-top-text" href="../staff/staff_list.php">・スタッフ管理画面</a></p>
            <p class="management-text"><a class="management-top-text" href="../product/pro_list.php">・商品管理画面</a></p>
            <p class="management-text"><a class="management-top-text" href="../order/order_download.php">・CSVデータダウンロード</a></p>
            <p class="management-text"><a class="management-top-text" href="staff_logout.php">ログアウト</a></p>
        </div>
    </main>
