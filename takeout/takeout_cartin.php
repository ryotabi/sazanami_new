...
try{
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($pro_code,$cart)){
            header('Location: takeout_incart.php');
            exit();
        }
    }
    $cart[]=$pro_code;
...
<div class="wrapper">
    ...
    <main class="main-img thanks-img">
        <div class="main-img-wrap thanks-img-wrap">
            <div class="content">
                <div class="thanks-wrap">
                    ...
                    <div class="toform-btn cartin_btn"><a href="takeout_cartlook.php"><p class="btn-text">カート一覧へ</p></a></div>
                </div>
            </div>
        </div>
    </main>
