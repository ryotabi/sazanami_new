...
<div class="wrapper">
    ...
    <main class="main-img vh-97 takeout-tab-img">
        <div class="main-img-wrap takeout-img-wrap">
            <div class="content">
                <div class="breadcrumb-area text-center takeout-bg ptb-100">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="form-wrap" id="form">
                    <h2 class="form-title">お客様情報確認</h2>
                    <form action="takeout_form_done.php" class="form takeout-form" method="POST">
                        <table class="takeout-table">
                            <tr>
                                <th>お名前</th>
                                <td><input type="text" name="onamae" class="text-form" required value="<?php print $name;?>"></td>
                            </tr>
                            <tr>
                                <th>電話番号</th>
                                <td><input type="text" name="tel" class="text-form" required value="<?php print $tel;?>"></td>
                            </tr>
                            <tr>
                                <th>メールアドレス</th>
                                <td><input type="email" name="email" class="text-form" required value="<?php print $email;?>"></td>
                            </tr>
                            <tr>
                                <th>お受け取り時間<br><span style="font-size: 15px;">（注文から30分調理の時間を頂きます。ご了承ください。）</span></th>
                                <td><input type="text" name="day" class="text-form" placeholder="例）10月7日18:00" required value="<?php print $day;?>"></td>
                            </tr>
                        </table>
                        <p class="takeout_check_text">上記の情報でよろしければ、OKボダンを押してください。</p>
                        <input type="submit" class="submit takeout-submit" value="OK">
                        <input type="submit" class="submit takeout-submit takeout_back" value="戻る" onclick="history.back()">
                    </form>
                </div>
            </div>
        </div>
